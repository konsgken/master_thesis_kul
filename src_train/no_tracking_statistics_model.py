...
import resnet_no_tracking_statistics as resnet
...
class DepthRegressionModel(nn.Module):
    def __init__(self, num_features_in, num_anchors=16, num_classes=15, feature_size=256):
        ...
        self.bn1 = nn.BatchNorm2d(feature_size, track_running_stats=False)
        self.act1 = nn.ReLU()
        self.conv2 = nn.Conv2d(feature_size, feature_size, kernel_size=3, padding=1)
        self.bn2 = nn.BatchNorm2d(feature_size, track_running_stats=False)
        self.act2 = nn.ReLU()
        self.conv3 = nn.Conv2d(feature_size, feature_size, kernel_size=3, padding=1)
        self.bn3 = nn.BatchNorm2d(feature_size, track_running_stats=False)
        self.act3 = nn.ReLU()
        self.conv4 = nn.Conv2d(feature_size, feature_size, kernel_size=3, padding=1)
        self.bn4 = nn.BatchNorm2d(feature_size, track_running_stats=False)
        self.act4 = nn.ReLU()
...
class GestureNet(nn.Module):
    def __init__(self, num_features_in, num_classes=10, feature_size=64):
...
class ResNetBackBone(nn.Module):
    def __init__(self):
        ...
        modelPreTrain18 = resnet.resnet18(pretrained=True)
        self.model = modelPreTrain18
...
class A2J_model(nn.Module):
    def __init__(self, num_classes, is_3D=True, is_gesture=False):
        ...
        self.GestureNet = GestureNet(256)
        if is_3D:
    ...
    def forward(self, x):
        ...
        gesture_classification = self.GestureNet(x3)
        if self.is_3D:
            DepthRegressionModel = self.DepthRegressionModel(x4)
            return (classification, regression, DepthRegressionModel), gesture_classification

        return (classification, regression), gesture_classification
