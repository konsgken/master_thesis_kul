...
import no_tracking_statistics_model as model
...
def train():
    ...
    train_samples = int(len(gesture_image_dataset) * 0.2)
    test_samples = len(gesture_image_dataset) - train_samples
